    ...
    def parse_infos(self):
        ...
        try:
            ...
            if source_at_begin:
                ...
                if '###' not in source_at_begin[2] or '===' not in source_at_begin[2] or '<Post' not in source_at_begin[2]:
                    description.extend([source_at_begin[2]])
                if len(source_at_begin[1]) > 2 and '<Post' not in source_at_begin[3]:
